...
function App() {
  return (
    <div className="bg-background relative overflow-clip flex flex-col justify-start items-center">
      <div className="left-0 top-[100px] w-[100vw] h-[800px] absolute  bg-gray-700 z-0 stars"></div>
      <div className="left-0 top-[100px] w-[100vw] h-[800px] absolute  bg-gray-700 z-0 twinkling"></div>
      ...
      <div className="mt-36 sm:mt-44 lg:mt-52 relative z-10 w-full flex justify-center app-padding z-10">
        <Contact />
      </div>
      <div className="mt-32 -mb-[2.3rem] sm:-mb-[4.2rem] mmd:-mb-[5rem] lg:-mb-[7rem] xl:-mb-[8rem] 2xl:-mb-[9rem] h-fit w-[100vw] text-center z-10">
        <Typography
